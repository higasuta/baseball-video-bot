...
def get_npb_video(history):
    """YouTubeのRSSフィードからNPB動画を取得（ブロックされない確実な方法）"""
    feeds = [
...
def main():
    ...
    if video_data:
        ...
        if video_data['type'] == 'npb':
            # YouTubeダウンロード（Androidクライアント偽装でブロック回避）
            ...
            with open(output_file, 'rb') as f:
                ...
                if up_res.status_code == 200:
                    ...
                    if 'id' in post_res:
                        ...
                        for i in range(30):
                            time.sleep(30)
                            # fieldsからfailure_reasonを除去し、純粋なstatus_codeのみを監視
